...
public class GHIssueEvent implements Consumer<GHIssueEvent.GHIssueEventConsumer> {
    ...
    public interface GHIssueEventConsumer {
         ...
         *
         * @param {@link
         *            GHMilestone} that the issue was removed from
         */
         ...
         *
         * @param {@link
         *            GHMilestone} that the issue was added to
         */
         ...
         *
         * @param {@link
         *            GHLabel} that was added to the issue
         */
         ...
         *
         * @param {@link
         *            GHLabel} that was removed from the issue
         */
         ...
         *
         * @param {@link
         *            GHUser} that was unassigned from the issue
         */
         ...
         *
         * @param {@link
         *            GHUser} that was assigned to the issue
         */
